...
public class InquilinosFragment extends Fragment {
    ...
    private InquilinoInmuebleAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        vm = ViewModelProvider.AndroidViewModelFactory
                ...
                .create(InquilinosViewModel.class);

        binding = FragmentInmueblesBinding.inflate(inflater, container, false);

        adapter = new InquilinoInmuebleAdapter(vm.getMContratos(), getLayoutInflater(), requireContext());
